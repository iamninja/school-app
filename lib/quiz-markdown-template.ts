/**
 * Starter content for the downloadable quiz-template.md and for the
 * "Check quiz markdown" validator's default textarea. Kept as the single
 * source of truth so both stay in sync — see lib/quiz-markdown.ts for the
 * format the parser actually enforces.
 */
export const QUIZ_MARKDOWN_TEMPLATE = [
  "<!--",
